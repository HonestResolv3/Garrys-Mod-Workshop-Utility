...
namespace GarrysModWorkshopUtil
{
    public partial class AboutPage : Form
    {
        ...
        private void btnVersion1Info_Click(object sender, EventArgs e)
        {
            lstChangelog.Items.Clear();
        ...
        private void btnVersion2Info_Click(object sender, EventArgs e)
        {
            lstChangelog.Items.Clear();
        ...
        private void btnVersion3Info_Click(object sender, EventArgs e)
        {
            lstChangelog.Items.Clear();
